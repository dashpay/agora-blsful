...
fn test_all_signature_schemes_legacy() {
    ...
    for scheme in &[
        ...
        let sig_modern =
            Signature::<Bls12381G2Impl>::from_bytes_with_mode(&modern_bytes, *scheme, false)
                .unwrap();
        ...
        let sig_legacy =
            Signature::<Bls12381G2Impl>::from_bytes_with_mode(&legacy_bytes, *scheme, true)
                .unwrap();
...
fn test_batch_verification_legacy() {
    ...
    let legacy_sigs: Vec<_> = sigs
        ...
        .map(|sig| {
            ...
            Signature::<Bls12381G2Impl>::from_bytes_with_mode(&bytes, SignatureSchemes::Basic, true)
                .unwrap()
        })
        .collect();
